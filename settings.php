    ...
    <tr>
        ...
        <td>
            <fieldset>
                ...
                <label title="All pages except flagged pages and posts - this plugin adds a checkbox in the post editor"><input type="radio" name="liblynx_protect" value="untagged"<?php echo ($liblynx_protect=='untagged')?'checked="checked"':''?>> All pages <u>except</u> flagged pages and posts</label><br>
